		...
		<Dialog open={internalOpen} onOpenChange={internalOnOpenChange}>
			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>Êtes-vous sûr de vouloir supprimer le contact {contact.nom} ?</DialogDescription>
				</DialogHeader>
				<DialogFooter>
					<DialogClose asChild>
						<Button variant="outline">Annuler</Button>
					</DialogClose>
					<Button variant="destructive" onClick={() => deleteContactAction(contact.id)}>
						Supprimer
					</Button>
				</DialogFooter>
			</DialogContent>
