...
export function KanbanBoardColumnTitle({
	...
	return (
		<h2
			className={cn("text-muted-foreground inline-flex items-center text-sm font-medium", className)}
			ref={ref}
...
export function KanbanBoardColumnButton({ className, ref, ...props }: ComponentProps<typeof Button>) {
	return (
		<Button
			className={cn("bg-sidebar text-primary hover:text-primary/80 w-full justify-start", className)}
			variant="outline"
			size="sm"
			ref={ref}
			{...props}
